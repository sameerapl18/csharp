...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LoginConnectionString %>" ProviderName="<%$ ConnectionStrings:LoginConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [TestLogin]" ></asp:SqlDataSource>
    </form>
</body>
</html>
