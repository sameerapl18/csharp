        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
           ...
           // monIntRate = monIntRate * 10;
            ...
            for (int i = 0; i <count; i++)
            {
                ...
                double monthlyInterest = mortgageAmount * monIntRate * 10;
                ...
                mortObj.balance = (Math.Round(mortgageAmount,2)) * 10;

                mortObj.date = startDate.Month.ToString() + "/" + startDate.Date.Day.ToString() + "/" + startDate.Date.Year.ToString();
            ...
            GridView1.DataBind();
            paymentDone.Text = "Monthly Payment ="+ Math.Round(monthlyPayment,2)+" ==> Interest = " + Math.Round(pieChartInterest,2) + " ; Principle = " + Math.Round(pieChartPrinciple,2);
