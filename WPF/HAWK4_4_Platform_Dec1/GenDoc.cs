...
using System.Text;
    ...
    public class GenDoc
    {
        ...
        public  int CheckValues(List<String> datastrings)
        {
            string[] fields = datastrings[0].Split(',');
            int returnValue = 0;
            int docType = Int32.Parse(fields[1]);
            //switch (docType)
            //{
                //case 13: AccountsPayable.PayableDoc test13 = new AccountsPayable.PayableDoc(datastrings);
                //    returnValue = test13.CheckValues(datastrings);
                //    break;
                //case 23: AccountsPayable.ReceivableDoc test23 = new AccountsPayable.ReceivableDoc(datastrings);
                //    returnValue = test23.CheckValues(datastrings);
                //    break;
                //case 60: AccountsPayable.AccPayable test60 = new AccountsPayable.AccPayable(datastrings);
                //    returnValue = test60.CheckValues(datastrings);
                //    break;
                //case 52: AccountsPayable.AccReceivable test61 = new AccountsPayable.AccReceivable(datastrings);
                //    returnValue = test61.CheckValues(datastrings);
            //        break;
            //}
            return returnValue;
        }
