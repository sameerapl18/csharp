<%@ Control Language="C#" AutoEventWireup="true" CodeFile="About.ascx.cs" Inherits="UserControls_About" %>
     ...
     <asp:Panel runat="server" class="secondflex">
            <asp:Panel runat="server" class="leftflex">
                 <asp:Panel runat="server" class="titletext">
                    ...
                    <asp:Label runat="server" class="secondheader">ABOUT</asp:Label>&nbsp;&nbsp;&nbsp;<asp:Label ID="webtext" runat="server" class="innercircle">WEB</asp:Label>
...
mollit<br /> anim id est laborum.
            ...
            <asp:Panel runat="server" class="rightflex">
                <asp:Image  width="578px" height="430px" src="../Images/img-about.jpg" runat="server"  />
...
<asp:Panel runat="server">
    <img width="1000px" src="../Images/about-usbig.jpg" />
